...
static void log_stderr(struct stratis_ctx *ctx,
                       int priority, const char *file, int line, const char *fn,
                       const char *format, va_list args)
{
 ...
 **/
STRATIS_EXPORT void stratis_set_userdata(struct stratis_ctx *ctx, void *userdata)
{
        if (ctx == NULL)
                return;
 ...
 * are logged.
 **/
STRATIS_EXPORT void stratis_set_log_priority(struct stratis_ctx *ctx, int priority)
{
...
STRATIS_EXPORT struct stratis_thing *stratis_thing_ref(struct stratis_thing *thing)
{
        if (!thing)
                return NULL;
        thing->refcount++;
...
STRATIS_EXPORT struct stratis_thing *stratis_thing_unref(struct stratis_thing *thing)
{
        if (thing == NULL)
                return NULL;
        thing->refcount--;
...
STRATIS_EXPORT struct stratis_ctx *stratis_thing_get_ctx(struct stratis_thing *thing)
{
        return thing->ctx;
}


STRATIS_EXPORT struct stratis_list_entry *stratis_thing_get_some_list_entry(struct stratis_thing *thing)
{
        return NULL;
}
