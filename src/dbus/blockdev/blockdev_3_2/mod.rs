...
use crate::dbus::blockdev::blockdev_3_0::{
    devnode_prop, hardware_info_prop, init_time_prop, physical_path_prop, pool_prop,
    set_user_info_method, tier_prop, total_physical_size_prop, user_info_prop,
};
...
impl BlockdevR2 {
    ...
    pub async fn unregister(
        ...
        connection
            .object_server()
            .remove::<BlockdevR2, _>(path)
            .await?;
        Ok(())
    }
}

#[interface(name = "org.storage.stratis3.blockdev.r2", introspection_docs = false)]
impl BlockdevR2 {
