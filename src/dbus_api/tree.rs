...
use either::Either;
use tokio::sync::{broadcast::Receiver, mpsc::UnboundedReceiver, RwLock};
...
use crate::{
    ...
    engine::{
        ActionAvailability, DevUuid, EncryptionInfo, FilesystemUuid, Lockable, LockedPoolsInfo,
        ...
        if self
            .property_changed_invalidated_signal(
                ...
                prop_hashmap! {
                    ...
                    consts::MANAGER_INTERFACE_NAME_3_9 => {
                        Vec::new(),
                        consts::STOPPED_POOLS_PROP.to_string() =>
                        box_variant!(stopped_pools_to_prop(&stopped_pools, true))
                    }
