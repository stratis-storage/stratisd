...
pub use self::{
    ...
    types::{
        ...
        MappingCreateAction, MappingDeleteAction, Name, PoolEncryptionInfo, PoolUuid, Redundancy,
        RenameAction, ReportType, SetCreateAction, SetDeleteAction, StratFilesystemDiff,
