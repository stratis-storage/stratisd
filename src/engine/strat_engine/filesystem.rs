...
impl StratFilesystem {
    pub fn initialize(pool_id: &PoolUuid,
        ...
        let new_thin_dev = try!(StratFilesystem::setup(pool_id,
                                                       thin_id,
                                                       fs_id,
                                                       name,
    ...
    pub fn setup(pool_id: &PoolUuid,
        ...
        let new_thin_dev = try!(ThinDev::setup(&device_name, dm, thin_pool, thin_id as u32, size));
    ...
    pub fn devnode(&self) -> EngineResult<PathBuf> {
