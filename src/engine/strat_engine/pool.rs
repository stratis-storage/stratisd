...
fn get_data_devs(blockdevs: Vec<(Uuid, BlockDevTier, &dyn BlockDev)>) -> Vec<&dyn BlockDev> {
    blockdevs
        .into_iter()
...
fn get_crypt_handles(blockdevs: &[&dyn BlockDev]) -> StratisResult<Vec<CryptHandle>> {
