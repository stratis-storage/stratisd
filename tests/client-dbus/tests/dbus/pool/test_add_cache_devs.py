...
class AddCacheDevsTestCase1(SimTestCase):
    ...
    def testSomeDevs(self):
        ...
        blockdevs2 = list(blockdevs(props={"Pool": pool, "Tier": BlockDevTiers.Cache}).search(managed_objects))
        ...
        blockdevs3 = blockdevs(props={"Tier": BlockDevTiers.Cache}).search(managed_objects)
