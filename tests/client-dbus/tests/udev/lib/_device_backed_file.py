...
"""
Abstract base class for file backed block devices
"""
import os
...
class DeviceFile(ABC):
    """
    Abstract base class for file backed block devices, derive and implement
    attach & detach for a working implementation.
    """
    ...
    def detach(self, device):
        """
        Detach a device from a file
        :param device: Device to detach from it's associated file
        :return: Device node
        """
